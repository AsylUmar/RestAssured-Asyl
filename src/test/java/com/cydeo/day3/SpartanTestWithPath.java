...
//verify each value
    ...
    @DisplayName("GET first element to /api/spartans")
    @Test
    public void test2(){
        Response response = given()
                .accept(ContentType.JSON)
        ...
        String lastFirstName = response.path("name[-1]"); //from the end
        System.out.println("lastFirstName = " + lastFirstName);

        //how to get all names and store inside the List
        List<String> names = response.path("name");//multiple names
